...
export default function Home() {
  return (
    <div className="lg:mt-[200px] ">
      <div className="mx-auto  sm:mb-[10px] lg:mb-[100px] flex flex-col items-center lg:pl-16 lg:pr-0 lg:grid lg:grid-rows-3 lg:grid-flow-col lg:gap-4 lg:max-w-5xl lg:h-[393px] lg:-mt-[100px] max-w-[400px]">
        {/* // Greeting */}
        <div className="mt-5 flex flex-col lg:row-span-1 lg:self-end lg:mt-8">
        ...
        <div className="w-screen mx-auto sm:w-fit p-5 mt-[10px] lg:row-span-1 lg:p-0">
          ...
          <Link
            href="/proyectos"
            className="text-sm bg-yellow py-[12px] px-[7px] flex gap-2 justify-center items-center mt-[21px] w-[137px] rounded-sm action-button"
          >
            Proyectos
            <MdOutlineWeb
              size="24"
        ...
        <div className="flex justify-center w-full lg:w-fit gap-10 mt-[44px] mb-10 lg:absolute lg:left-0 lg:flex-col lg:pl-4">
          <a
            href="https://www.linkedin.com/in/domakedev/"
            target="_blank"
          >
            <Image
              src={LinkedinIcon}
